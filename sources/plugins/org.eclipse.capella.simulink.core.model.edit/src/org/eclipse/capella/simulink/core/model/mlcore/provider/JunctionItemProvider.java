...
/**
 * This is the item provider adapter for a {@link org.eclipse.capella.simulink.core.model.mlcore.Junction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JunctionItemProvider extends AStateItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Junction_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Junction_type_feature", "_UI_Junction_type"),
				 MLCorePackage.Literals.JUNCTION__TYPE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Junction.class)) {
			case MLCorePackage.JUNCTION__TYPE:
