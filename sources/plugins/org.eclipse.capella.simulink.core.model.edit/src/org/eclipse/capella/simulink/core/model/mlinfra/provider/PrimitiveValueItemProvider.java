...
/**
 * This is the item provider adapter for a {@link org.eclipse.capella.simulink.core.model.mlinfra.PrimitiveValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PrimitiveValueItemProvider extends ValueItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PrimitiveValue_specification_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PrimitiveValue_specification_feature", "_UI_PrimitiveValue_type"),
				 MLInfraPackage.Literals.PRIMITIVE_VALUE__SPECIFICATION,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PrimitiveValue.class)) {
			case MLInfraPackage.PRIMITIVE_VALUE__SPECIFICATION:
