...
/**
 * This is the item provider adapter for a {@link org.eclipse.capella.simulink.core.model.mlcore.Literal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LiteralItemProvider extends NamedElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MLCorePackage.Literals.LITERAL__VALUE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Literal.class)) {
			case MLCorePackage.LITERAL__VALUE:
