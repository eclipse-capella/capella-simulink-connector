 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.capella.simulink.core.model.mloperation.impl.ConfigurationImpl#getParent <em>Parent</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConfigurationImpl extends ParameterizedElementImpl implements Configuration {
	/**
	...
	protected EClass eStaticClass() {
		return MloperationPackage.Literals.CONFIGURATION;
	}
		...
		if (parent != null && parent.eIsProxy()) {
			...
			if (parent != oldParent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MloperationPackage.CONFIGURATION__PARENT, oldParent, parent));
			}
		}
		return parent;
	}
	...
	public void setParent(Configuration newParent) {
		...
		parent = newParent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MloperationPackage.CONFIGURATION__PARENT, oldParent, parent));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MloperationPackage.CONFIGURATION__PARENT:
