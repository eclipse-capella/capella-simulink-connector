...
add_block('simulink/Ports & Subsystems/In1', 'PA_container_1/sub_1/FunctionalExchange_1');
set_param('PA_container_1/sub_1/FunctionalExchange_1', 'Port', '1');
set_param('PA_container_1/sub_1/FunctionalExchange_1', 'OutDataTypeStr', 'Bus: busFE_FunctionalExchange_1');
set_param('PA_container_1/sub_1/FunctionalExchange_1', 'Tag', 'ModelerId:fb45b6cd-452e-48e5-94b8-a2c634d36d84');
add_block('simulink/Ports & Subsystems/Out1', 'PA_container_1/sub_1/Sub_FunctionalExchange_1');
set_param('PA_container_1/sub_1/Sub_FunctionalExchange_1', 'Port', '1');
set_param('PA_container_1/sub_1/Sub_FunctionalExchange_1', 'OutDataTypeStr', 'Bus: busFE_Sub_FunctionalExchange_1');
set_param('PA_container_1/sub_1/Sub_FunctionalExchange_1', 'BusOutputAsStruct', 'on');
set_param('PA_container_1/sub_1/Sub_FunctionalExchange_1', 'Tag', 'ModelerId:8efaf64b-a45d-4cfc-9f40-1be624687e15');
...
p_Block = get_param('PA_container_1/sub_1/FunctionalExchange_1', 'handle');
...
p_Block = get_param('PA_container_1/sub_1/Sub_FunctionalExchange_1', 'handle');
p_handles = get_param(p_Block, 'PortHandles');
...
set_param('PA_container_1/sub_2/Sub_FunctionalExchange_1', 'Tag', 'ModelerId:79348269-33bd-4522-a8fb-21afeddd74bf');
...
set_param('PA_container_1/sub_2/FunctionalExchange_2', 'Tag', 'ModelerId:171fe0da-d7f1-4b89-874b-3fcce7204f85');
t_Block = add_block('simulink/Sinks/Terminator', 'PA_container_1/sub_2/Terminator', 'MakeNameUnique', 'on' );
t_handles = get_param(t_Block, 'PortHandles');
p_Block = get_param('PA_container_1/sub_2/Sub_FunctionalExchange_1', 'handle');
p_handles = get_param(p_Block, 'PortHandles');
terminator = t_handles.Inport(1);
port = p_handles.Outport(1);
...
g_handles = get_param(g_Block, 'PortHandles');
p_Block = get_param('PA_container_1/sub_2/FunctionalExchange_2', 'handle');
p_handles = get_param(p_Block, 'PortHandles');
ground = g_handles.Outport(1);
port = p_handles.Inport(1);
