...
importFromBaseWorkspace(PA_FunctionalExchanges_Categories, 'varList', {'busFE_sub', 'busFE_bottom2_to_leaf2', 'busFE_leaf1_to_bottom1'}, 'existingVarsAction','overwrite');
