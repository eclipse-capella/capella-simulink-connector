...
importFromBaseWorkspace(PA_Data, 'varList', {'PhysicalQuantity_1', 'busClass_Class_1', 'busEI_ExchangeItem_1', 'busEI_sub_ExchangeItem_1', 'busEI_ExchangeItem_2'}, 'existingVarsAction','overwrite');
saveChanges(PA_Data);
clear PA_Data;
...
importFromBaseWorkspace(PA_FunctionalExchanges_Categories, 'varList', {'busFE_FunctionalExchange_1', 'busFE_FunctionalExchange_2', 'busFE_leaf1_to_bottom1', 'busFE_bottom2_to_leaf2', 'busFE_sub', 'busFE_FunctionalExchange_1', 'busFE_Sub_FunctionalExchange_1', 'busFE_FunctionalExchange_2', 'busFE_sub_FunctionalExchange_1'}, 'existingVarsAction','overwrite');
...
addLabel(file, 'Capella Layer', 'PA');
if isfile('data/PA/PA_Top_2.sldd')
	PA_Top_2 = Simulink.data.dictionary.open('data/PA/PA_Top_2.sldd');
else
	PA_Top_2 = Simulink.data.dictionary.create('data/PA/PA_Top_2.sldd');
end
addDataSource(PA_Top_2, 'PA_FunctionalExchanges_Categories.sldd');
saveChanges(PA_Top_2);
clear PA_Top_2;
file = proj.addFile('data/PA/PA_Top_2.sldd');
addLabel(file, 'Capella Layer', 'PA');
...
addLabel(file, 'Capella Layer', 'PA');
evalin('base', "clear 'PhysicalQuantity_1' 'busClass_Class_1' 'busEI_sub_ExchangeItem_1' 'busFE_bottom2_to_leaf2' 'busFE_FunctionalExchange_1' 'busFE_leaf1_to_bottom1' 'busFE_sub_FunctionalExchange_1' 'busFE_FunctionalExchange_2' 'busFE_sub' 'busFE_Sub_FunctionalExchange_1' 'busEI_ExchangeItem_1' 'busEI_ExchangeItem_2'");
new_system('PA_sub_2');
...
set_param('PA_container_1', 'Tag', 'ModelerId:fd35433b-16dc-4898-a915-fff7b41c426e');
...
set_param('PA_container_1/FunctionalExchange_1', 'Tag', 'ModelerId:fb45b6cd-452e-48e5-94b8-a2c634d36d84');
...
set_param('PA_container_1/FunctionalExchange_2', 'Tag', 'ModelerId:171fe0da-d7f1-4b89-874b-3fcce7204f85');
add_block('CapellaElements/ModelRef/Model_Function', 'PA_container_1/Reference_to_sub_1');
set_param('PA_container_1/Reference_to_sub_1', 'Tag', 'ModelerId:9d68ddf2-be8b-42f2-a28c-729f7fe949d1');
...
clear handles;
add_block('CapellaElements/ModelRef/Model_Function', 'PA_container_1/Reference_to_sub_2');
set_param('PA_container_1/Reference_to_sub_2', 'Tag', 'ModelerId:ee137cc4-d52d-484a-b685-16c449142824');
set_param('PA_container_1/Reference_to_sub_2', 'ModelFile', 'PA_sub_2')
handles = get_param('PA_container_1/Reference_to_sub_2', 'porthandles');
...
addLabel(file, 'Capella Layer', 'PA');
new_system('PA_Top_2');
set_param('PA_Top_2', 'Tag', 'ModelerId:0278fdbd-9082-4bc2-bc59-3ba753307413');
set_param('PA_Top_2', 'DataDictionary', 'PA_Top_2.sldd');
add_block('CapellaElements/ModelRef/Model_Function', 'PA_Top_2/Reference_to_leaf_1');
set_param('PA_Top_2/Reference_to_leaf_1', 'Tag', 'ModelerId:2df54e0f-10fc-4498-a73d-5ef1a75ee70a');
set_param('PA_Top_2/Reference_to_leaf_1', 'ModelFile', 'PA_leaf_1')
handles = get_param('PA_Top_2/Reference_to_leaf_1', 'porthandles');
set_param(handles.Outport(1), 'Tag', 'ModelerId:29dd7f04-b10f-41f0-8bd5-cb04a7d20f17');
clear handles;
add_block('CapellaElements/ModelRef/Model_Function', 'PA_Top_2/Reference_to_leaf_2');
set_param('PA_Top_2/Reference_to_leaf_2', 'Tag', 'ModelerId:178afa0b-0f08-41d8-ac7f-9db851bdf4bf');
set_param('PA_Top_2/Reference_to_leaf_2', 'ModelFile', 'PA_leaf_2')
add_block('CapellaElements/Subsystem/Function', 'PA_Top_2/container_1');
set_param('PA_Top_2/container_1', 'Tag', 'ModelerId:9df477a4-df2e-45ca-b5b7-e3d8beb58477');
CapSLBridge.internal.cleanSubsystem('PA_Top_2/container_1');
add_block('simulink/Ports & Subsystems/In1', 'PA_Top_2/container_1/FunctionalExchange_1');
set_param('PA_Top_2/container_1/FunctionalExchange_1', 'Port', '1');
set_param('PA_Top_2/container_1/FunctionalExchange_1', 'OutDataTypeStr', 'Bus: busFE_FunctionalExchange_1');
set_param('PA_Top_2/container_1/FunctionalExchange_1', 'Tag', 'ModelerId:260b2635-00bc-43f8-a1b1-12f639e39480');
add_block('simulink/Ports & Subsystems/Out1', 'PA_Top_2/container_1/FunctionalExchange_2');
set_param('PA_Top_2/container_1/FunctionalExchange_2', 'Port', '1');
set_param('PA_Top_2/container_1/FunctionalExchange_2', 'OutDataTypeStr', 'Bus: busFE_FunctionalExchange_2');
set_param('PA_Top_2/container_1/FunctionalExchange_2', 'BusOutputAsStruct', 'on');
set_param('PA_Top_2/container_1/FunctionalExchange_2', 'Tag', 'ModelerId:3368f681-65e9-47be-990c-c9a61bb23858');
add_block('CapellaElements/ModelRef/Model_Function', 'PA_Top_2/container_1/Reference_to_sub_1');
set_param('PA_Top_2/container_1/Reference_to_sub_1', 'Tag', 'ModelerId:003b2df1-c09c-48e7-9811-5b9563057a96');
set_param('PA_Top_2/container_1/Reference_to_sub_1', 'ModelFile', 'PA_sub_1')
handles = get_param('PA_Top_2/container_1/Reference_to_sub_1', 'porthandles');
set_param(handles.Outport(1), 'Tag', 'ModelerId:b4ad6c0a-7966-420f-bb2f-696a36b99c08');
clear handles;
add_block('CapellaElements/Subsystem/Function', 'PA_Top_2/container_1/sub_2');
set_param('PA_Top_2/container_1/sub_2', 'Tag', 'ModelerId:2b467853-ab2c-436a-8cf3-fb59304ae4c0');
CapSLBridge.internal.cleanSubsystem('PA_Top_2/container_1/sub_2');
add_block('simulink/Ports & Subsystems/Out1', 'PA_Top_2/container_1/sub_2/FunctionalExchange_2');
set_param('PA_Top_2/container_1/sub_2/FunctionalExchange_2', 'Port', '1');
set_param('PA_Top_2/container_1/sub_2/FunctionalExchange_2', 'OutDataTypeStr', 'Bus: busFE_FunctionalExchange_2');
set_param('PA_Top_2/container_1/sub_2/FunctionalExchange_2', 'BusOutputAsStruct', 'on');
set_param('PA_Top_2/container_1/sub_2/FunctionalExchange_2', 'Tag', 'ModelerId:3368f681-65e9-47be-990c-c9a61bb23858');
add_block('simulink/Ports & Subsystems/In1', 'PA_Top_2/container_1/sub_2/sub_FunctionalExchange_1');
set_param('PA_Top_2/container_1/sub_2/sub_FunctionalExchange_1', 'Port', '1');
set_param('PA_Top_2/container_1/sub_2/sub_FunctionalExchange_1', 'OutDataTypeStr', 'Bus: busFE_sub_FunctionalExchange_1');
set_param('PA_Top_2/container_1/sub_2/sub_FunctionalExchange_1', 'Tag', 'ModelerId:92dfd0ca-0b71-4235-b595-9c326ec57e82');
add_block('CapellaElements/ModelRef/Model_Function', 'PA_Top_2/container_1/sub_2/Reference_to_bottom_1');
set_param('PA_Top_2/container_1/sub_2/Reference_to_bottom_1', 'Tag', 'ModelerId:18d24771-6019-4037-bbd9-8be358085c80');
set_param('PA_Top_2/container_1/sub_2/Reference_to_bottom_1', 'ModelFile', 'PA_bottom_1')
handles = get_param('PA_Top_2/container_1/sub_2/Reference_to_bottom_1', 'porthandles');
set_param(handles.Outport(1), 'Tag', 'ModelerId:3368f681-65e9-47be-990c-c9a61bb23858');
clear handles;
handles = get_param('PA_Top_2/container_1/sub_2/Reference_to_bottom_1', 'PortHandles');
source = handles.Outport(1);
handles = get_param('PA_Top_2/container_1/sub_2/FunctionalExchange_2', 'PortHandles');
target = handles.Inport(1);
line = add_line('PA_Top_2/container_1/sub_2', source, target, 'autorouting','smart');
set_param(line, 'Name', 'FunctionalExchange_2');
set_param( line, 'Tag', 'ModelerId:3368f681-65e9-47be-990c-c9a61bb23858');
clear line handles source target;
handles = get_param('PA_Top_2/container_1/sub_2/sub_FunctionalExchange_1', 'PortHandles');
source = handles.Outport(1);
handles = get_param('PA_Top_2/container_1/sub_2/Reference_to_bottom_1', 'PortHandles');
target = handles.Inport(1);
line = add_line('PA_Top_2/container_1/sub_2', source, target, 'autorouting','smart');
...
clear line handles source target;
try
	Simulink.BlockDiagram.arrangeSystem('PA_Top_2/container_1/sub_2');
catch
end
handles = get_param('PA_Top_2/container_1/FunctionalExchange_1', 'PortHandles');
source = handles.Outport(1);
handles = get_param('PA_Top_2/container_1/Reference_to_sub_1', 'PortHandles');
target = handles.Inport(1);
line = add_line('PA_Top_2/container_1', source, target, 'autorouting','smart');
set_param(line, 'Name', 'FunctionalExchange_1');
set_param( line, 'Tag', 'ModelerId:260b2635-00bc-43f8-a1b1-12f639e39480');
clear line handles source target;
handles = get_param('PA_Top_2/container_1/sub_2', 'PortHandles');
source = handles.Outport(1);
handles = get_param('PA_Top_2/container_1/FunctionalExchange_2', 'PortHandles');
target = handles.Inport(1);
line = add_line('PA_Top_2/container_1', source, target, 'autorouting','smart');
set_param(line, 'Name', 'FunctionalExchange_2');
set_param( line, 'Tag', 'ModelerId:3368f681-65e9-47be-990c-c9a61bb23858');
...
clear line handles source target;
try
	Simulink.BlockDiagram.arrangeSystem('PA_Top_2/container_1');
catch
end
handles = get_param('PA_Top_2/Reference_to_leaf_1', 'PortHandles');
source = handles.Outport(1);
handles = get_param('PA_Top_2/container_1', 'PortHandles');
target = handles.Inport(1);
line = add_line('PA_Top_2', source, target, 'autorouting','smart');
set_param(line, 'Name', 'FunctionalExchange_1');
set_param( line, 'Tag', 'ModelerId:be094c00-f0b3-440a-a0c2-1e7febcd20df');
clear line handles source target;
handles = get_param('PA_Top_2/container_1', 'PortHandles');
source = handles.Outport(1);
handles = get_param('PA_Top_2/Reference_to_leaf_2', 'PortHandles');
target = handles.Inport(1);
line = add_line('PA_Top_2', source, target, 'autorouting','smart');
set_param(line, 'Name', 'FunctionalExchange_2');
...
clear line handles source target;
try
	Simulink.BlockDiagram.arrangeSystem('PA_Top_2');
catch
end
save_system('PA_Top_2', fullfile(project_path, 'models/PA/PA_Top_2.slx'));
file = proj.addFile('models/PA/PA_Top_2.slx');
addLabel(file, 'Capella Layer', 'PA');
