...
importFromBaseWorkspace(PA_FunctionalExchanges_Categories, 'varList', {'busFE_bottom2_to_leaf2', 'busFE_leaf1_to_bottom1', 'busFE_sub'}, 'existingVarsAction','overwrite');
...
set_param('PA_container', 'Tag', 'ModelerId:2485b2d7-b4db-4990-8e77-846d93b1b030');
set_param('PA_container', 'DataDictionary', 'PA_container.sldd');
add_block('simulink/Ports & Subsystems/Out1', 'PA_container/bottom2_to_leaf2');
set_param('PA_container/bottom2_to_leaf2', 'Port', '1');
set_param('PA_container/bottom2_to_leaf2', 'OutDataTypeStr', 'Bus: busFE_bottom2_to_leaf2');
set_param('PA_container/bottom2_to_leaf2', 'BusOutputAsStruct', 'on');
set_param('PA_container/bottom2_to_leaf2', 'Tag', 'ModelerId:9de1a4fc-6543-4647-8fd3-60098c5dabe0');
add_block('simulink/Ports & Subsystems/In1', 'PA_container/leaf1_to_bottom1');
set_param('PA_container/leaf1_to_bottom1', 'Port', '1');
set_param('PA_container/leaf1_to_bottom1', 'OutDataTypeStr', 'Bus: busFE_leaf1_to_bottom1');
set_param('PA_container/leaf1_to_bottom1', 'Tag', 'ModelerId:1c92e414-4dc0-445a-9cfa-419fa214911f');
add_block('CapellaElements/ModelRef/Model_Function', 'PA_container/Reference_to_bottom2');
set_param('PA_container/Reference_to_bottom2', 'Tag', 'ModelerId:ffa504fd-8e29-4095-8e15-dd41f7e08583');
set_param('PA_container/Reference_to_bottom2', 'ModelFile', 'PA_bottom2')
handles = get_param('PA_container/Reference_to_bottom2', 'porthandles');
set_param(handles.Outport(1), 'Tag', 'ModelerId:9de1a4fc-6543-4647-8fd3-60098c5dabe0');
clear handles;
add_block('CapellaElements/Subsystem/Function', 'PA_container/sub');
set_param('PA_container/sub', 'Tag', 'ModelerId:1173662b-cfe4-4a2f-9e14-ec1b4d3d7193');
CapSLBridge.internal.cleanSubsystem('PA_container/sub');
add_block('simulink/Ports & Subsystems/In1', 'PA_container/sub/leaf1_to_bottom1');
set_param('PA_container/sub/leaf1_to_bottom1', 'Port', '1');
set_param('PA_container/sub/leaf1_to_bottom1', 'OutDataTypeStr', 'Bus: busFE_leaf1_to_bottom1');
set_param('PA_container/sub/leaf1_to_bottom1', 'Tag', 'ModelerId:1c92e414-4dc0-445a-9cfa-419fa214911f');
add_block('simulink/Ports & Subsystems/Out1', 'PA_container/sub/sub');
set_param('PA_container/sub/sub', 'Port', '1');
set_param('PA_container/sub/sub', 'OutDataTypeStr', 'Bus: busFE_sub');
set_param('PA_container/sub/sub', 'BusOutputAsStruct', 'on');
set_param('PA_container/sub/sub', 'Tag', 'ModelerId:395722eb-7184-475d-81dc-21e78f051c2b');
add_block('CapellaElements/ModelRef/Model_Function', 'PA_container/sub/Reference_to_bottom1');
set_param('PA_container/sub/Reference_to_bottom1', 'Tag', 'ModelerId:0d18653e-f4cb-4b57-9d99-6fa587a4634f');
set_param('PA_container/sub/Reference_to_bottom1', 'ModelFile', 'PA_bottom1')
handles = get_param('PA_container/sub/Reference_to_bottom1', 'porthandles');
set_param(handles.Outport(1), 'Tag', 'ModelerId:395722eb-7184-475d-81dc-21e78f051c2b');
clear handles;
handles = get_param('PA_container/sub/leaf1_to_bottom1', 'PortHandles');
source = handles.Outport(1);
handles = get_param('PA_container/sub/Reference_to_bottom1', 'PortHandles');
target = handles.Inport(1);
line = add_line('PA_container/sub', source, target, 'autorouting','smart');
...
handles = get_param('PA_container/sub/Reference_to_bottom1', 'PortHandles');
source = handles.Outport(1);
handles = get_param('PA_container/sub/sub', 'PortHandles');
target = handles.Inport(1);
line = add_line('PA_container/sub', source, target, 'autorouting','smart');
...
clear line handles source target;
try
	Simulink.BlockDiagram.arrangeSystem('PA_container/sub');
catch
end
handles = get_param('PA_container/Reference_to_bottom2', 'PortHandles');
source = handles.Outport(1);
handles = get_param('PA_container/bottom2_to_leaf2', 'PortHandles');
target = handles.Inport(1);
line = add_line('PA_container', source, target, 'autorouting','smart');
set_param(line, 'Name', 'bottom2_to_leaf2');
set_param( line, 'Tag', 'ModelerId:9de1a4fc-6543-4647-8fd3-60098c5dabe0');
clear line handles source target;
handles = get_param('PA_container/leaf1_to_bottom1', 'PortHandles');
source = handles.Outport(1);
handles = get_param('PA_container/sub', 'PortHandles');
target = handles.Inport(1);
line = add_line('PA_container', source, target, 'autorouting','smart');
set_param(line, 'Name', 'leaf1_to_bottom1');
set_param( line, 'Tag', 'ModelerId:1c92e414-4dc0-445a-9cfa-419fa214911f');
