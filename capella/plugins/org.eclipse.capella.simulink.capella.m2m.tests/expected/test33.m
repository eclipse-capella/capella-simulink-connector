...
importFromBaseWorkspace(PA_FunctionalExchanges_Categories, 'varList', {'busFE_FunctionalExchange_1', 'busFE_Sub_FunctionalExchange_1', 'busFE_FunctionalExchange_2'}, 'existingVarsAction','overwrite');
...
add_block('CapellaElements/Subsystem/Function', 'PA_container_1/sub_1');
set_param('PA_container_1/sub_1', 'Tag', 'ModelerId:9d68ddf2-be8b-42f2-a28c-729f7fe949d1');
CapSLBridge.internal.cleanSubsystem('PA_container_1/sub_1');
add_block('simulink/Ports & Subsystems/In1', 'PA_container_1/sub_1/FIP_1');
set_param('PA_container_1/sub_1/FIP_1', 'Port', '1');
set_param('PA_container_1/sub_1/FIP_1', 'OutDataTypeStr', 'Bus: busFE_FunctionalExchange_1');
set_param('PA_container_1/sub_1/FIP_1', 'Tag', 'ModelerId:fb45b6cd-452e-48e5-94b8-a2c634d36d84');
add_block('simulink/Ports & Subsystems/Out1', 'PA_container_1/sub_1/FOP_1');
set_param('PA_container_1/sub_1/FOP_1', 'Port', '1');
set_param('PA_container_1/sub_1/FOP_1', 'OutDataTypeStr', 'Bus: busFE_Sub_FunctionalExchange_1');
set_param('PA_container_1/sub_1/FOP_1', 'BusOutputAsStruct', 'on');
set_param('PA_container_1/sub_1/FOP_1', 'Tag', 'ModelerId:8efaf64b-a45d-4cfc-9f40-1be624687e15');
t_Block = add_block('simulink/Sinks/Terminator', 'PA_container_1/sub_1/Terminator', 'MakeNameUnique', 'on' );
t_handles = get_param(t_Block, 'PortHandles');
p_Block = get_param('PA_container_1/sub_1/FIP_1', 'handle');
p_handles = get_param(p_Block, 'PortHandles');
terminator = t_handles.Inport(1);
port = p_handles.Outport(1);
add_line('PA_container_1/sub_1', port, terminator);
clear t_Block t_handles p_Block p_handles terminator port
g_Block = add_block('simulink/Sources/Ground', 'PA_container_1/sub_1/Ground', 'MakeNameUnique', 'on' );
g_handles = get_param(g_Block, 'PortHandles');
p_Block = get_param('PA_container_1/sub_1/FOP_1', 'handle');
p_handles = get_param(p_Block, 'PortHandles');
ground = g_handles.Outport(1);
port = p_handles.Inport(1);
add_line('PA_container_1/sub_1', ground, port);
clear g_Block g_handles p_Block p_handles ground port
try
	Simulink.BlockDiagram.arrangeSystem('PA_container_1/sub_1');
catch
end
add_block('CapellaElements/Subsystem/Function', 'PA_container_1/sub_2');
set_param('PA_container_1/sub_2', 'Tag', 'ModelerId:ee137cc4-d52d-484a-b685-16c449142824');
CapSLBridge.internal.cleanSubsystem('PA_container_1/sub_2');
add_block('simulink/Ports & Subsystems/In1', 'PA_container_1/sub_2/FIP_1');
set_param('PA_container_1/sub_2/FIP_1', 'Port', '1');
set_param('PA_container_1/sub_2/FIP_1', 'OutDataTypeStr', 'Bus: busFE_Sub_FunctionalExchange_1');
set_param('PA_container_1/sub_2/FIP_1', 'Tag', 'ModelerId:79348269-33bd-4522-a8fb-21afeddd74bf');
add_block('simulink/Ports & Subsystems/Out1', 'PA_container_1/sub_2/FOP_1');
set_param('PA_container_1/sub_2/FOP_1', 'Port', '1');
set_param('PA_container_1/sub_2/FOP_1', 'OutDataTypeStr', 'Bus: busFE_FunctionalExchange_2');
set_param('PA_container_1/sub_2/FOP_1', 'BusOutputAsStruct', 'on');
set_param('PA_container_1/sub_2/FOP_1', 'Tag', 'ModelerId:171fe0da-d7f1-4b89-874b-3fcce7204f85');
t_Block = add_block('simulink/Sinks/Terminator', 'PA_container_1/sub_2/Terminator', 'MakeNameUnique', 'on' );
t_handles = get_param(t_Block, 'PortHandles');
p_Block = get_param('PA_container_1/sub_2/FIP_1', 'handle');
p_handles = get_param(p_Block, 'PortHandles');
terminator = t_handles.Inport(1);
port = p_handles.Outport(1);
add_line('PA_container_1/sub_2', port, terminator);
clear t_Block t_handles p_Block p_handles terminator port
g_Block = add_block('simulink/Sources/Ground', 'PA_container_1/sub_2/Ground', 'MakeNameUnique', 'on' );
g_handles = get_param(g_Block, 'PortHandles');
p_Block = get_param('PA_container_1/sub_2/FOP_1', 'handle');
p_handles = get_param(p_Block, 'PortHandles');
ground = g_handles.Outport(1);
port = p_handles.Inport(1);
add_line('PA_container_1/sub_2', ground, port);
clear g_Block g_handles p_Block p_handles ground port
try
...
handles = get_param('PA_container_1/sub_1', 'PortHandles');
