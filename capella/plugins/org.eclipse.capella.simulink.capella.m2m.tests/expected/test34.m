...
addLabel(file, 'Capella Layer', 'PA');
if isfile('data/PA/PA_FunctionalChain_1.sldd')
	PA_FunctionalChain_1 = Simulink.data.dictionary.open('data/PA/PA_FunctionalChain_1.sldd');
else
	PA_FunctionalChain_1 = Simulink.data.dictionary.create('data/PA/PA_FunctionalChain_1.sldd');
end
addDataSource(PA_FunctionalChain_1, 'PA_FunctionalExchanges_Categories.sldd');
saveChanges(PA_FunctionalChain_1);
clear PA_FunctionalChain_1;
file = proj.addFile('data/PA/PA_FunctionalChain_1.sldd');
addLabel(file, 'Capella Layer', 'PA');
...
add_block('simulink/Ports & Subsystems/In1', 'PA_Leaf_2/FIP_1');
set_param('PA_Leaf_2/FIP_1', 'Port', '1');
set_param('PA_Leaf_2/FIP_1', 'OutDataTypeStr', 'Bus: busFE_FunctionalExchange_2');
set_param('PA_Leaf_2/FIP_1', 'Tag', 'ModelerId:6540787d-e351-4218-b9a0-ee9ffec589ca');
...
p_Block = get_param('PA_Leaf_2/FIP_1', 'handle');
...
add_block('simulink/Ports & Subsystems/Out1', 'PA_leaf_1/FOP_1');
set_param('PA_leaf_1/FOP_1', 'Port', '1');
set_param('PA_leaf_1/FOP_1', 'OutDataTypeStr', 'Bus: busFE_FunctionalExchange_1');
set_param('PA_leaf_1/FOP_1', 'BusOutputAsStruct', 'on');
set_param('PA_leaf_1/FOP_1', 'Tag', 'ModelerId:4a3f6acd-cb1d-4d89-b2d9-46d9d59f36e9');
g_Block = add_block('simulink/Sources/Ground', 'PA_leaf_1/Ground', 'MakeNameUnique', 'on' );
g_handles = get_param(g_Block, 'PortHandles');
p_Block = get_param('PA_leaf_1/FOP_1', 'handle');
p_handles = get_param(p_Block, 'PortHandles');
...
add_block('simulink/Ports & Subsystems/Out1', 'PA_sub_2/FOP_1');
set_param('PA_sub_2/FOP_1', 'Port', '1');
set_param('PA_sub_2/FOP_1', 'OutDataTypeStr', 'Bus: busFE_FunctionalExchange_2');
set_param('PA_sub_2/FOP_1', 'BusOutputAsStruct', 'on');
set_param('PA_sub_2/FOP_1', 'Tag', 'ModelerId:171fe0da-d7f1-4b89-874b-3fcce7204f85');
add_block('simulink/Ports & Subsystems/In1', 'PA_sub_2/FIP_1');
set_param('PA_sub_2/FIP_1', 'Port', '1');
set_param('PA_sub_2/FIP_1', 'OutDataTypeStr', 'Bus: busFE_Sub_FunctionalExchange_1');
set_param('PA_sub_2/FIP_1', 'Tag', 'ModelerId:79348269-33bd-4522-a8fb-21afeddd74bf');
g_Block = add_block('simulink/Sources/Ground', 'PA_sub_2/Ground', 'MakeNameUnique', 'on' );
g_handles = get_param(g_Block, 'PortHandles');
p_Block = get_param('PA_sub_2/FOP_1', 'handle');
p_handles = get_param(p_Block, 'PortHandles');
ground = g_handles.Outport(1);
port = p_handles.Inport(1);
...
t_handles = get_param(t_Block, 'PortHandles');
p_Block = get_param('PA_sub_2/FIP_1', 'handle');
p_handles = get_param(p_Block, 'PortHandles');
terminator = t_handles.Inport(1);
port = p_handles.Outport(1);
...
add_block('simulink/Ports & Subsystems/Out1', 'PA_sub_1/FOP_1');
set_param('PA_sub_1/FOP_1', 'Port', '1');
set_param('PA_sub_1/FOP_1', 'OutDataTypeStr', 'Bus: busFE_Sub_FunctionalExchange_1');
set_param('PA_sub_1/FOP_1', 'BusOutputAsStruct', 'on');
set_param('PA_sub_1/FOP_1', 'Tag', 'ModelerId:8efaf64b-a45d-4cfc-9f40-1be624687e15');
add_block('simulink/Ports & Subsystems/In1', 'PA_sub_1/FIP_1');
set_param('PA_sub_1/FIP_1', 'Port', '1');
set_param('PA_sub_1/FIP_1', 'OutDataTypeStr', 'Bus: busFE_FunctionalExchange_1');
set_param('PA_sub_1/FIP_1', 'Tag', 'ModelerId:fb45b6cd-452e-48e5-94b8-a2c634d36d84');
g_Block = add_block('simulink/Sources/Ground', 'PA_sub_1/Ground', 'MakeNameUnique', 'on' );
g_handles = get_param(g_Block, 'PortHandles');
p_Block = get_param('PA_sub_1/FOP_1', 'handle');
p_handles = get_param(p_Block, 'PortHandles');
ground = g_handles.Outport(1);
port = p_handles.Inport(1);
...
t_handles = get_param(t_Block, 'PortHandles');
p_Block = get_param('PA_sub_1/FIP_1', 'handle');
p_handles = get_param(p_Block, 'PortHandles');
terminator = t_handles.Inport(1);
port = p_handles.Outport(1);
...
add_block('simulink/Ports & Subsystems/In1', 'PA_container_1/FIP_1');
set_param('PA_container_1/FIP_1', 'Port', '1');
set_param('PA_container_1/FIP_1', 'OutDataTypeStr', 'Bus: busFE_FunctionalExchange_1');
set_param('PA_container_1/FIP_1', 'Tag', 'ModelerId:fb45b6cd-452e-48e5-94b8-a2c634d36d84');
add_block('simulink/Ports & Subsystems/Out1', 'PA_container_1/FOP_1');
set_param('PA_container_1/FOP_1', 'Port', '1');
set_param('PA_container_1/FOP_1', 'OutDataTypeStr', 'Bus: busFE_FunctionalExchange_2');
set_param('PA_container_1/FOP_1', 'BusOutputAsStruct', 'on');
set_param('PA_container_1/FOP_1', 'Tag', 'ModelerId:171fe0da-d7f1-4b89-874b-3fcce7204f85');
...
clear handles;
handles = get_param('PA_container_1/FIP_1', 'PortHandles');
...
handles = get_param('PA_container_1/Reference_to_sub_2', 'PortHandles');
source = handles.Outport(1);
handles = get_param('PA_container_1/FOP_1', 'PortHandles');
target = handles.Inport(1);
line = add_line('PA_container_1', source, target, 'autorouting','smart');
...
addLabel(file, 'Capella Layer', 'PA');
new_system('PA_FunctionalChain_1');
set_param('PA_FunctionalChain_1', 'Tag', 'ModelerId:97db5c56-ae63-4c1c-9694-20b07bf11d9d');
set_param('PA_FunctionalChain_1', 'DataDictionary', 'PA_FunctionalChain_1.sldd');
add_block('CapellaElements/ModelRef/Model_Function', 'PA_FunctionalChain_1/Reference_to_container_1');
set_param('PA_FunctionalChain_1/Reference_to_container_1', 'Tag', 'ModelerId:fd35433b-16dc-4898-a915-fff7b41c426e');
set_param('PA_FunctionalChain_1/Reference_to_container_1', 'ModelFile', 'PA_container_1')
handles = get_param('PA_FunctionalChain_1/Reference_to_container_1', 'porthandles');
set_param(handles.Outport(1), 'Tag', 'ModelerId:171fe0da-d7f1-4b89-874b-3fcce7204f85');
clear handles;
add_block('CapellaElements/ModelRef/Model_Function', 'PA_FunctionalChain_1/Reference_to_sub_1');
set_param('PA_FunctionalChain_1/Reference_to_sub_1', 'Tag', 'ModelerId:9d68ddf2-be8b-42f2-a28c-729f7fe949d1');
set_param('PA_FunctionalChain_1/Reference_to_sub_1', 'ModelFile', 'PA_sub_1')
handles = get_param('PA_FunctionalChain_1/Reference_to_sub_1', 'porthandles');
set_param(handles.Outport(1), 'Tag', 'ModelerId:8efaf64b-a45d-4cfc-9f40-1be624687e15');
clear handles;
add_block('CapellaElements/ModelRef/Model_Function', 'PA_FunctionalChain_1/Reference_to_sub_2');
set_param('PA_FunctionalChain_1/Reference_to_sub_2', 'Tag', 'ModelerId:ee137cc4-d52d-484a-b685-16c449142824');
set_param('PA_FunctionalChain_1/Reference_to_sub_2', 'ModelFile', 'PA_sub_2')
handles = get_param('PA_FunctionalChain_1/Reference_to_sub_2', 'porthandles');
set_param(handles.Outport(1), 'Tag', 'ModelerId:171fe0da-d7f1-4b89-874b-3fcce7204f85');
clear handles;
add_block('CapellaElements/ModelRef/Model_Function', 'PA_FunctionalChain_1/Reference_to_leaf_1');
set_param('PA_FunctionalChain_1/Reference_to_leaf_1', 'Tag', 'ModelerId:ffbf1867-6cbe-4c5b-ab0e-514ee01d5201');
set_param('PA_FunctionalChain_1/Reference_to_leaf_1', 'ModelFile', 'PA_leaf_1')
handles = get_param('PA_FunctionalChain_1/Reference_to_leaf_1', 'porthandles');
set_param(handles.Outport(1), 'Tag', 'ModelerId:4a3f6acd-cb1d-4d89-b2d9-46d9d59f36e9');
clear handles;
add_block('CapellaElements/ModelRef/Model_Function', 'PA_FunctionalChain_1/Reference_to_Leaf_2');
set_param('PA_FunctionalChain_1/Reference_to_Leaf_2', 'Tag', 'ModelerId:4cadc4a0-eed1-4ed8-a5ef-e85838cc70ee');
set_param('PA_FunctionalChain_1/Reference_to_Leaf_2', 'ModelFile', 'PA_Leaf_2')
handles = get_param('PA_FunctionalChain_1/Reference_to_sub_1', 'PortHandles');
source = handles.Outport(1);
handles = get_param('PA_FunctionalChain_1/Reference_to_sub_2', 'PortHandles');
target = handles.Inport(1);
line = add_line('PA_FunctionalChain_1', source, target, 'autorouting','smart');
set_param(line, 'Name', 'Sub_FunctionalExchange_1');
set_param( line, 'Tag', 'ModelerId:566e5d9f-f6bc-468a-9fd5-ded0f4a10c51');
clear line handles source target;
handles = get_param('PA_FunctionalChain_1/Reference_to_leaf_1', 'PortHandles');
...
handles = get_param('PA_FunctionalChain_1/Reference_to_sub_2', 'PortHandles');
source = handles.Outport(1);
handles = get_param('PA_FunctionalChain_1/Reference_to_Leaf_2', 'PortHandles');
target = handles.Inport(1);
line = add_line('PA_FunctionalChain_1', source, target, 'autorouting','smart');
...
clear line handles source target;
try
	Simulink.BlockDiagram.arrangeSystem('PA_FunctionalChain_1');
catch
end
save_system('PA_FunctionalChain_1', fullfile(project_path, 'models/PA/PA_FunctionalChain_1.slx'));
file = proj.addFile('models/PA/PA_FunctionalChain_1.slx');
addLabel(file, 'Capella Layer', 'PA');
