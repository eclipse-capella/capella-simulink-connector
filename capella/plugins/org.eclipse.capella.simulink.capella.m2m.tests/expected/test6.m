...
importFromBaseWorkspace(PA_FunctionalExchanges_Categories, 'varList', {'busFE_FunctionalExchange_1', 'busFE_FunctionalExchange_2', 'busFE_sub_FunctionalExchange_1'}, 'existingVarsAction','overwrite');
