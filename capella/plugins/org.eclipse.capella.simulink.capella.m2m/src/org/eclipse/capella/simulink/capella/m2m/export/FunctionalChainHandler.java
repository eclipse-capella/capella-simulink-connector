...
import org.eclipse.capella.simulink.capella.m2m.export.visitors.FunctionalChainVisitor;
 ...
 *
 */
public class FunctionalChainHandler extends ExportHandler {

	@Override
	public void configure() {
		this.purposeID = IConstants.TRANSFORMATION_CAPELLA_FUNCTIONALCHAIN_TO_PIVOT_PURPOSE;
		this.mappingID = IConstants.TRANSFORMATION_CAPELLA_FUNCTIONALCHAIN_TO_PIVOT_MAPPING;
	...
	public Class<?> getRelatedMetaClass() {
		return FunctionalChain.class;
	}
	
	@Override
	protected List<AVisitor> getVisitors(List<Object> collector) {
		return Arrays.asList(new AVisitor[] {new FunctionalChainVisitor(collector), new FunctionVisitor(collector, false)});
	}
}
